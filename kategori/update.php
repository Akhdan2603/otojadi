...
<head>
    ...
    <title>Update Category - VirtualZone</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4 text-center"><i class="fas fa-edit"></i> Update Category</h1>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="kategori" name="kategori" required placeholder="Enter category name" class="form-control" value="<?php echo $item['kategori'] ?>">
                                        </div>
                                    </div>
                                </div>
...
if (isset($_POST['simpan'])) {
    ...
    $sql = "UPDATE kategori SET kategori='$kat' WHERE id='$id'";
    $db->runSQL($sql);
