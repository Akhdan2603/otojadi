...
if (isset($_POST['simpan'])) {
    ...
    if (empty($nama_type)) {
        ...
        $sql = "INSERT INTO type VALUES (NULL, '$nama_type')";
        $db->runSQL($sql);
...
<head>
    ...
    <title>Insert Type - otojadi</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4 text-center"><i class="fas fa-plus-circle"></i> Insert Type</h1>
                        ...
                        <div class="form-container">
                            <form action="" method="post">
                                <div class="row justify-content-center">
                                    <div class="col-md-6">
                                        <h5 class="mb-3 text-center"><i class="fas fa-info-circle"></i> Type Information</h5>

                                        <div class="mb-3">
                                            <label for="nama_type" class="form-label">Type Name *</label>
                                            <input type="text" id="nama_type" name="nama_type" required placeholder="Enter type name" class="form-control">
                                        </div>
